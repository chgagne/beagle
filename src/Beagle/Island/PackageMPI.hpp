 ...
 *  \ingroup DBIM
 */
class PackageMPI : public PackageAbstract
{

public:

	//! Distrib::Island::PackageMPI allocator type.
	typedef AllocatorT< PackageMPI, PackageAbstract::Alloc > Alloc;
	//! Distrib::Island::PackageMPI handle type.
	typedef PointerT< PackageMPI, PackageAbstract::Handle > Handle;
	//! Distrib::Island::PackageMPI bag type.
	typedef ContainerT< PackageMPI, PackageAbstract::Bag > Bag;

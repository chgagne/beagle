...
/*!
 *  \file   Beagle/ES/RecombinationWeightedOp.cpp
 *  \brief  Source code of class ES::RecombinationWeightedOp.
 ...
 */
Beagle::ES::RecombinationWeightedOp::RecombinationWeightedOp(std::string inRecombPbName,

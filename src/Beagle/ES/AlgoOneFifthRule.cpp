...
/*!
 *  \file   Beagle/ES/AlgoOneFifthRule.cpp
 *  \brief  Source code of class ES::AlgoOneFifthRule.
 ...
 */
ES::AlgoOneFifthRule::AlgoOneFifthRule(void) :
		Algorithm("ES-AlgoOneFifthRule")
{ }
...
void ES::AlgoOneFifthRule::configure(Evolver& ioEvolver, System& ioSystem)
{
	...
	ES::AdaptOneFifthRuleFltVecOp::Alloc::Handle lAdaptOpAlloc =
	    castHandleT<ES::AdaptOneFifthRuleFltVecOp::Alloc>(lFactory.getAllocator(lAdaptOpName));
